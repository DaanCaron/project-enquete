...
const RightSideMenu: React.FC<props> = ({ surveys, fetchAllQuestionsBySurveyId, reFetch, submit, message }) => {

    return (
        <div className="bg-[#252525]  ml-4 h-full w-64 p-4 rounded shadow-lg flex flex-col justify-between">
